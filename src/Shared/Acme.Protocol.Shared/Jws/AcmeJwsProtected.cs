...
public class AcmeJwsProtected
{
    ...
    public void SetExtensionData(string key, object value)
    {
        ...
        this.ExtensionData[key] = JsonSerializer.SerializeToElement(value, JwsSystemTextJsonSerializer.DefaultOptions);
    }
    ...
    public T? GetExtensionData<T>(string key)
    {
        ...
        return value.Deserialize<T>(JwsSystemTextJsonSerializer.DefaultOptions);
    }
}
